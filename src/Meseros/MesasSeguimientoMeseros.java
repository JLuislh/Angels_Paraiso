...
public final class MesasSeguimientoMeseros extends javax.swing.JFrame {
    ...
    private void ME1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ME1MouseClicked
        ...
        id_mesa = 1;
        noorden = orden1;
        MenuSeguimientoMeseros F = new MenuSeguimientoMeseros(noorden,id_mesa);
        F.setVisible(true);
        this.dispose();
        }
...
private void Etiquetas() {
        ...
        String texto21 ="<html><center><body>MESA 21<br>Orden No<br><font color='white'>"+ordenmesa[21]+"</font></body></center></html>";
        ME21.setText(texto21);
        String texto22 ="<html><center><body>MESA 22<br>Orden No<br><font color='white'>"+ordenmesa[22]+"</font></body></center></html>";
        ME22.setText(texto22);
        String texto23 ="<html><center><body>MESA 23<br>Orden No<br><font color='white'>"+ordenmesa[23]+"</font></body></center></html>";
        ME23.setText(texto23);
        String texto24 ="<html><center><body>MESA 24<br>Orden No<br><font color='white'>"+ordenmesa[24]+"</font></body></center></html>";
        ME24.setText(texto24);
        String texto25 ="<html><center><body>MESA 25<br>Orden No<br><font color='white'>"+ordenmesa[25]+"</font></body></center></html>";
        ME25.setText(texto25);
        String texto26 ="<html><center><body>MESA 26<br>Orden No<br><font color='white'>"+ordenmesa[26]+"</font></body></center></html>";
        ME26.setText(texto26);
        String texto27 ="<html><center><body>MESA 27<br>Orden No<br><font color='white'>"+ordenmesa[27]+"</font></body></center></html>";
        ME27.setText(texto27);
        String texto28 ="<html><center><body>MESA 28<br>Orden No<br><font color='white'>"+ordenmesa[28]+"</font></body></center></html>";
        ME28.setText(texto28);
        String texto29 ="<html><center><body>MESA 29<br>Orden No<br><font color='white'>"+ordenmesa[29]+"</font></body></center></html>";
        ME29.setText(texto29);
        String texto30 ="<html><center><body>MESA 30<br>Orden No<br><font color='white'>"+ordenmesa[30]+"</font></body></center></html>";
        ME30.setText(texto30);
        String texto31 ="<html><center><body>MESA 31<br>Orden No<br><font color='white'>"+ordenmesa[31]+"</font></body></center></html>";
